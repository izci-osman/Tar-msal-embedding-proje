...
# Example usage
npy_files = ['./embeddings/image_embeddings.npy', './embeddings/image_embeddings1.npy', './embeddings/image_embeddings2.npy']  # List of .npy files containing embeddings
